...
namespace AutoScroll
{
	public class AutoScrollViewController : UIViewController, INChartSeriesDataSource, INChartValueAxisDataSource
	{
		...
		public override void LoadView()
		{
			...
			m_view.Chart.UserInteractionMode = (m_view.Chart.UserInteractionMode) ^ (NChartUserInteraction.ProportionalZoom | NChartUserInteraction.VerticalZoom | NChartUserInteraction.VerticalMove);
